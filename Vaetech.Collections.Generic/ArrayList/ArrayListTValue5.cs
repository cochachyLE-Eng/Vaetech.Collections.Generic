...
namespace Vaetech.Collections.Generic
{
    public class ArrayList<TKey, TValue1, TValue2, TValue3, TValue4, TValue5> : IList<Array<TKey, TValue1, TValue2, TValue3, TValue4, TValue5>>
    {
        ...
        public virtual void AddOrReplace(TKey key, TValue1 value1, TValue2 value2, TValue3 value3, TValue4 value4, TValue5 value5)
            => this.AddOrReplace(new Array<TKey, TValue1, TValue2, TValue3, TValue4, TValue5>(key, value1, value2, value3, value4, value5));
        public virtual void AddOrReplace(Array<TKey, TValue1, TValue2, TValue3, TValue4, TValue5> item)
        {
            Range range = GetRangeAdd(1);
